...
FROM somnergy/z6m_prover_base:latest
RUN apt update 
...
COPY prover/target/release/z6m_prover /usr/bin/z6m_prover
# COPY ./target/elf-compilation/riscv32im-succinct-zkvm-elf/release/z6m_guest /usr/local/bin/z6m_guest
COPY prover/target/elf-compilation/riscv64im-succinct-zkvm-elf/release/z6m_guest /usr/local/bin/z6m_guest
