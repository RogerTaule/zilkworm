...
".LBBmemcpy0_12:\n"  // misaligned dispatch via jump table
    ...
    "lla a5, .LJTI0_0\n"
    "add a4, a4, a5\n"
    // lwu (zero-extend) instead of lw: jump-table entries are 32-bit
    // absolute addresses. Our text base is 0x80000000, so every entry
    // has bit 31 set. `lw` would sign-extend to 0xFFFFFFFF8XXXXXXX
    // and `jr` would land in unmapped memory. SP1's text base 0x79000000
    // didn't have this problem because bit 31 is clear there.
    "lwu a5, 0(a4)\n"
    "ld a4, 0(a1)\n"
    "jr a5\n"
